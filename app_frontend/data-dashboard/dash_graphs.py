...
class Linechart:
    def __init__(self, graph_counter, data):
        ...
        self.data = data
        investments = pd.melt(self.data, id_vars=['anio_corte','municipio'], value_vars=['inversion_transformacion','inversion_conectividad', 'inversion'])
    ...
    def update_graph(self, app):
        ...
        def update_linechart(value="medellin"):
            ...
            fig.add_trace(
                go.Scatter(x=self.data[self.data['municipio']==value]["anio_corte"], y=self.data[self.data['municipio']==value]["inversion_transformacion"], name="Inversión MinTC - Transformación"),
                secondary_y=False,
            )
            fig.add_trace(
                go.Scatter(x=self.data[self.data['municipio']==value]["anio_corte"], y=self.data[self.data['municipio']==value]["inversion_conectividad"], name="Inversión MinTC - Conectividad"),
                secondary_y=False,
            )
            fig.add_trace(
                go.Scatter(x=self.data[self.data['municipio']==value]["anio_corte"], y=self.data[self.data['municipio']==value]["inversion"], name="Inversión MinTC - Total"),
                secondary_y=False,
            )

            fig.add_trace(
                go.Scatter(x=self.data[self.data['municipio']==value]["anio_corte"], y=self.data[self.data['municipio']==value]["componente_de_resultados"], name="Índice Calidad de Vida"),
                secondary_y=True,
            )
            return fig
...
class Bargraph:
    ...
    def update_graph(self, app):
        ...
        def update_bargraph(x_option_name="anio_corte", y_option_name="cobertura_media_neta"):
